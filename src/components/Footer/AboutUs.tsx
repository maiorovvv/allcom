		...
		<div className="footer__widget footer__widget--width">
			...
			<div className="footer__widget--inner">
				<p className="footer__widget--desc text-ofwhite mb-20">
					Lorem ipsum dolor sit amet, consectetur adipisici ti elit seddo eiusmod tempor incididunt
					utlabore <br></br> et dolore magna aliqua enim ad minim veniam quisnostrud exercitation
					ullamco Lorem, ipsum dolor <br></br> sit amet consectetur adipisicing elit. Maxime
					expedita omnis placeat quibusdam ducimus <br></br> in quae sit cum. Laborum tempore maxime
					quia? Impedit esse
				</p>
